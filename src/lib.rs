...
//! and flow- and block-collection nesting. Comment tokens and events are emitted by default;
//! setting [`Options::emit_comments`] to `false` recognizes and validates comments without
//! capturing their text or emitting them. The defaults allow 96 buffered comment events, 1024
//! characters of simple-key lookahead, 255 nested flow collections, and 255 nested block
//! collections. Existing constructors use these defaults.
